 ...
 * Encapsulates authentication actions, validations,
 * and error handling for login scenarios.
 */
public class LoginPage {
    ...
    public LoginPage assertLoginPageTitle() {
        CustomSoftAssertion.softAssertion.assertEquals(
                driver.browser().getPageTitle(),
                getPropertyValue("appTitle"),
    ...
    /**
     * Soft validation used when login success
     * is part of a larger test flow.
     */
    ...
    /**
     * Hard validation used as a transition
     * to the Home page after successful login.
     */
