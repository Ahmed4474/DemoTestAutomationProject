...
│   ├── java  
│   │   └── com.swaglabs  
│   │       ├── drivers        (Browser initialization & ThreadLocal driver)  
...
Steps:
1. Download the WebDriver that matches your browser version
2. Add the driver path to your system PATH
...
Note:
Automatic WebDriver management will be added in future improvements.
...
- web.properties  
  Controls browser type and execution mode

- environment.properties  
  Application URLs and static values

- waits.properties  
  Explicit wait configuration

- log4j2.properties  
  Logging configuration and file structure
...
- Generated report:
test-outputs/allure-report

If `openAllureAutomatically=true`,
the report will open automatically after execution.
...
- Log files are generated per execution
- Logs location:
test-outputs/Logs
...
- Taken after each test based on result
...
- Headless execution enhancements
